...
typedef struct {
    ...
    socklen_t         socklen;
    ngx_str_t         name;           //add by shengyan 2012/12/10
    ngx_str_t         upstream_name;  //add by shengyan 2013/02/19
...
ngx_int_t ngx_http_upstream_check_enable_handler(ngx_http_request_t *r);    //add by shengyan 2012/12/10
ngx_int_t ngx_http_upstream_check_disable_handler(ngx_http_request_t *r);   //add by shengyan 2012/12/10
