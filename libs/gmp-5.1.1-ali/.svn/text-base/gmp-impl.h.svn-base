...
__GMP_DECLSPEC void      mp_create_swt (mp_slw_t **, mp_srcptr, mp_size_t);
__GMP_DECLSPEC void      mp_destroy_swt (mp_slw_t *);
__GMP_DECLSPEC void      mpn_powm_swt (mp_ptr, mp_srcptr, mp_size_t, mp_srcptr, mp_size_t, mp_ptr, mp_slw_t *);
