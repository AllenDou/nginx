...
#define mpz_create_swt __gmpz_create_swt
__GMP_DECLSPEC void mpz_create_swt (void*, mpz_srcptr);

#define mpz_destroy_swt __gmpz_destroy_swt
__GMP_DECLSPEC void mpz_destroy_swt (void*);

#define mpz_powm_swt __gmpz_powm_swt
__GMP_DECLSPEC void mpz_powm_swt (mpz_ptr, mpz_srcptr, void*, mpz_srcptr);
